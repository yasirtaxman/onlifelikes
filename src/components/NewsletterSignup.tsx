...
export function NewsletterSignup() {
  ...
  return (
    <section
      ...
      className="rounded-3xl bg-pine px-6 py-10 text-center text-cream sm:px-10"
    >
      <h2 className="text-2xl font-bold">Get one practical idea a week</h2>
      <p className="mx-auto mt-2 max-w-xl text-sm leading-relaxed text-cream/80">
        Join our free newsletter for home ideas, honest buying guides, and
        small-space solutions — no spam, unsubscribe anytime.
      </p>
      {done ? (
        <p className="mt-6 font-semibold text-sage">
        ...
        >
          ...
          <input
            ...
            className="flex-1 rounded-full border border-cream/20 bg-pine-dark px-5 py-3 text-sm text-cream placeholder:text-cream/40 focus:border-sage focus:outline-2 focus:outline-sage/60"
          />
          <button
            type="submit"
            className="rounded-full bg-sage px-6 py-3 text-sm font-bold text-pine-dark transition-colors hover:bg-cream"
          >
            Subscribe
          </button>
        </form>
